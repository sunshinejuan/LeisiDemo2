...
public class PromotionAdapter extends BaseAdapter {
    ...
    private List<VBean.HotestProductBean> data;
    private boolean isButtonisCheck;
    DisplayImageOptions options;

    public PromotionAdapter(Context context, List<VBean.HotestProductBean> data, boolean isButtonisCheck, DisplayImageOptions options) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        VBean.HotestProductBean info = data.get(position);
        holder.name.setText(info.getProduct_cname());
